...
| [52](https://github.com/nostr-protocol/nips/blob/master/52.md) | Calendar events | communityd | Events-channel thread roots (kinds 31922/31923), RSVPs (kind 31925), served as an ICS feed ([channels.md](channels.md)) |
